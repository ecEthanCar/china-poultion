...
city_names_codes <- read_excel("Shared_Data/FIXED-city-names-codes.xlsx")

code <- city_names_codes
code$Region <- gsub("(?i)district", "", code$Region)
code$Region <- gsub("(?i)city", "", code$Region)
code$Province <- gsub("(Inner Mongolia)", "", code$Region)

#Fix translation columns, and remove instances of "City" and "District"
