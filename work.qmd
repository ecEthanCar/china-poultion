...
# Carbon_Triangle_CEIC <- read_excel("Shared_Data/Carbon Triangle--CEIC.xlsx", sheet = 1, col_names = FALSE)
# 
# colnames(Carbon_Triangle_CEIC) <- Carbon_Triangle_CEIC[1, ]
# Carbon_Triangle_CEIC <- Carbon_Triangle_CEIC[-1, ]

Carbon_Triangle <- read_csv("Shared_Data/Carbon Triangle Copy - My Series.csv")

names(Carbon_Triangle)[names(Carbon_Triangle) == 'Data_type'] <- "Province"
