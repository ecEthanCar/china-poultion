...
smaller <- left_join(smaller, bigger_n, by = c("year", "Region", "Statistical_Division_Code"))

smaller |> write_csv(file = "data/IN_PROGRESS_carbon_emissions_est_prop_gdp.csv")
