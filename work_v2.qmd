...
bigger <- merge(encoded_data_6, pivot_estate_property_n, by = c("Region", "Province", "year"))
...
##IMPORTANT##
bigger_2 <- merge(pivot_gdp_n, bigger, by = c("Region", "Province", "year")) |>
  select(!pct)
...
bigger_3 <- merge(bigger_2, lat_long, by = c("Region", "Province"))
