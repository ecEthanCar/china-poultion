...
# smaller_na <- smaller_2 |> filter(is.na(Province)) |> distinct(Province.Code)

smaller_na_cleaned <- for_cleaned |> filter(Province.Code == smaller_na$Province.Code) |> distinct(Province.Code, Province)
...
# |>
#   filter(Annual_Real_Estate_Investment.x == Annual_Real_Estate_Investment.y)
