...
lat_long$Region <- gsub("Alar", "Aral", lat_long$Region)
lat_long$Region <- gsub("Baishali", "Baisha Li", lat_long$Region)
lat_long$Region <- gsub("\\bZhongxian\\b", "Zhong", lat_long$Region)
lat_long$Region <- gsub("Bayannuer", "Bayannur", lat_long$Region)
lat_long$Region <- gsub("Wulanchabu", "Ulanqab", lat_long$Region)
lat_long$Region <- gsub("West Qing", "Xiqing", lat_long$Region)
lat_long$Region <- gsub("Ganzi", "Garze", lat_long$Region)
lat_long$Region <- gsub("Guoluo", "Golog", lat_long$Region)
